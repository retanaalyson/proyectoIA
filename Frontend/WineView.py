...
class Ui_WineView(object):
    ...
    def retranslateUi(self, WineView):
        ...
        self.label_2.setText(_translate("WineView", "Clasificar la calidad del vino"))
        self.label.setText(_translate("WineView", "Seleccione el tipo"))
        self.label_3.setText(_translate("WineView", "Ingrese el nivel de acido"))
        self.label_4.setText(_translate("WineView", "Ingrese el volatic nivel"))
        self.label_5.setText(_translate("WineView", "Ingrese el nivel de citrico"))
        self.label_6.setText(_translate("WineView", "Ingrese el chlorides nivel"))
        self.label_7.setText(_translate("WineView", "Ingrese el nivel de azucar"))
        self.label_8.setText(_translate("WineView", "Ingrese el nivel de pH"))
        self.label_9.setText(_translate("WineView", "Ingrese el nivel de densidad"))
        self.label_10.setText(_translate("WineView", "Ingrese el nivel de dioxido"))
        self.label_11.setText(_translate("WineView", "Ingrese el nivel de sulfur"))
        self.label_12.setText(_translate("WineView", "Ingrese el nivel de alcohol"))
        self.label_13.setText(_translate("WineView", "Ingrese el sulphates nivel"))
        self.pushButton_13.setText(_translate("WineView", "Clasificar"))
        self.Type.setItemText(0, _translate("WineView", "Rojo"))
        self.Type.setItemText(1, _translate("WineView", "Blanco"))
        self.label_14.setText(_translate("WineView", "Calidad"))
